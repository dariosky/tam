...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tamArchive_viaggioarchive', (
            ...
            ('flag_esclusivo', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('conducente', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=5, null=True, blank=True)),
            ('flag_richiesto', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('cliente', self.gf('django.db.models.fields.CharField')(max_length=40, null=True)),
            ('prezzo', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2)),
            ('prezzo_detail', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('flag_fineMese', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('flag_fatturazione', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('flag_cartaDiCredito', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('flag_pagamentoDifferito', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('numero_pratica', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('flag_arrivo', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('punti_abbinata', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('note', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('padre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tamArchive.ViaggioArchive'], null=True, blank=True)),
        ))
