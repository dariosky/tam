...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UtentePrenotazioni'
        db.create_table('prenotazioni_utenteprenotazioni', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='prenotazioni', unique=True, to=orm['auth.User'])),
            ('cliente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tam.Cliente'])),
            ('luogo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tam.Luogo'])),
            ('nome_operatore', self.gf('django.db.models.fields.CharField')(max_length=40, null=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True)),
        ))
        db.send_create_signal('prenotazioni', ['UtentePrenotazioni'])

        # Adding model 'Prenotazione'
        db.create_table('prenotazioni_prenotazione', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prenotazioni.UtentePrenotazioni'])),
            ('cliente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tam.Cliente'])),
            ('data_registrazione', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('data_corsa', self.gf('django.db.models.fields.DateTimeField')()),
            ('pax', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('is_collettivo', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_arrivo', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('luogo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tam.Luogo'])),
            ('pagamento', self.gf('django.db.models.fields.CharField')(default='D', max_length=1)),
            ('note_camera', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('note_cliente', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('note', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('viaggio', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tam.Viaggio'], unique=True, null=True)),
        ))
        db.send_create_signal('prenotazioni', ['Prenotazione'])


    def backwards(self, orm):
        # Deleting model 'UtentePrenotazioni'
        db.delete_table('prenotazioni_utenteprenotazioni')

        # Deleting model 'Prenotazione'
        db.delete_table('prenotazioni_prenotazione')
    ...
    models = {
        ...
        'prenotazioni.utenteprenotazioni': {
            'Meta': {'ordering': "('cliente', 'user')", 'object_name': 'UtentePrenotazioni'},
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tam.Cliente']"}),
