...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prenotazione.attachment'
        db.add_column(u'prenotazioni_prenotazione', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prenotazione.attachment'
        db.delete_column(u'prenotazioni_prenotazione', 'attachment')
    ...
    models = {
        ...
        u'tam.viaggio': {
            ...
            'annullato': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
