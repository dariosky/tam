...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(
            ...
            self.gf("django.db.models.fields.related.ForeignKey")(
                to=orm["tam.Luogo"], on_delete=models.PROTECT
            ),
        )
        ...
        db.alter_column(
            ...
            self.gf("django.db.models.fields.related.OneToOneField")(
                to=orm["tam.Viaggio"], unique=True, null=True, on_delete=models.PROTECT
            ),
        )
        ...
        db.alter_column(
            ...
            "cliente_id",
            self.gf("django.db.models.fields.related.ForeignKey")(
                to=orm["tam.Cliente"], on_delete=models.PROTECT
            ),
        )
    ...
    def backwards(self, orm):
        ...
        db.alter_column(
            "prenotazioni_utenteprenotazioni",
            "luogo_id",
            self.gf("django.db.models.fields.related.ForeignKey")(to=orm["tam.Luogo"]),
        )
        # Deleting field 'Prenotazione.had_attachment'
        db.delete_column("prenotazioni_prenotazione", "had_attachment")
