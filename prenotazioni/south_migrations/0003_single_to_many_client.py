...
class Migration(DataMigration):
	...
	def forwards(self, orm):
		...
		for utentePrenotazioni in orm.UtentePrenotazioni.objects.all():
			...
			print "Aggiungo il cliente %s all'utente %s" % (
												utentePrenotazioni.cliente.nome,
												utentePrenotazioni.user.username
											)
			utentePrenotazioni.save()

	def backwards(self, orm):
		raise RuntimeError("Non posso annullare la migrazione: non saprei che utente scegliere")
