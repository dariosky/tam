...
class Migration(SchemaMigration):
    def forwards(self, orm):
            ...
            (
                ...
                (
                    ...
                    self.gf("django.db.models.fields.related.OneToOneField")(
                        related_name="prenotazioni", unique=True, to=orm["auth.User"]
                    ),
                ),
                (
                    "cliente",
        ...
        db.create_table(
            "prenotazioni_prenotazione",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                (
                    "owner",
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        to=orm["prenotazioni.UtentePrenotazioni"]
                    ),
                ),
                (
                    "cliente",
                ...
                (
                    "viaggio",
                    self.gf("django.db.models.fields.related.OneToOneField")(
                        to=orm["tam.Viaggio"], unique=True, null=True
                    ),
                ),
            ),
        )
    ...
    models = {
        ...
        "prenotazioni.utenteprenotazioni": {
            "Meta": {
                ...
                "object_name": "UtentePrenotazioni",
            },
            "cliente": (
                "django.db.models.fields.related.ForeignKey",
                [],
