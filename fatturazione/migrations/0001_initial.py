...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fatturazione_fattura', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('emessa_da', self.gf('django.db.models.fields.TextField')()),
            ('emessa_a', self.gf('django.db.models.fields.TextField')()),
            ('note', self.gf('django.db.models.fields.TextField')()),
            ('tipo', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('data', self.gf('django.db.models.fields.DateField')()),
            ('anno', self.gf('django.db.models.fields.IntegerField')()),
            ('progressivo', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('fatturazione', ['Fattura'])

        # Adding model 'RigaFattura'
        db.create_table('fatturazione_rigafattura', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fattura', self.gf('django.db.models.fields.related.ForeignKey')(related_name='righe', to=orm['fatturazione.Fattura'])),
            ('descrizione', self.gf('django.db.models.fields.TextField')()),
            ('note', self.gf('django.db.models.fields.TextField')()),
            ('qta', self.gf('django.db.models.fields.IntegerField')()),
            ('prezzo', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2)),
            ('iva', self.gf('django.db.models.fields.IntegerField')()),
            ('viaggio', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fattura', null=True, to=orm['tam.Viaggio'])),
        ))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'RigaFattura'
        db.delete_table('fatturazione_rigafattura')
    ...
    models = {
        ...
        'fatturazione.rigafattura': {
            ...
            'viaggio': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fattura'", 'null': 'True', 'to': "orm['tam.Viaggio']"})
        },
        'tam.bacino': {
