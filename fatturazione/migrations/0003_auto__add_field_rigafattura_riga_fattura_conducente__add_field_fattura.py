...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fattura.archiviata'
        db.add_column('fatturazione_fattura', 'archiviata', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Fattura.archiviata'
        db.delete_column('fatturazione_fattura', 'archiviata')
    ...
    models = {
        ...
        'fatturazione.rigafattura': {
            ...
            'riga_fattura_conducente': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'fattura_conducente_collegata'", 'unique': 'True', 'null': 'True', 'to': "orm['fatturazione.RigaFattura']"}),
