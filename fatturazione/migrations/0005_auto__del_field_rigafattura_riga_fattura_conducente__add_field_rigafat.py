...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RigaFattura.riga_fattura_conducente'
        db.delete_column('fatturazione_rigafattura', 'riga_fattura_conducente_id')

        # Adding field 'RigaFattura.riga_fattura_consorzio'
        db.add_column('fatturazione_rigafattura', 'riga_fattura_consorzio', self.gf('django.db.models.fields.related.OneToOneField')(related_name='fattura_conducente_collegata', unique=True, null=True, to=orm['fatturazione.RigaFattura']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RigaFattura.riga_fattura_conducente'
        db.add_column('fatturazione_rigafattura', 'riga_fattura_conducente', self.gf('django.db.models.fields.related.OneToOneField')(related_name='fattura_conducente_collegata', unique=True, null=True, to=orm['fatturazione.RigaFattura']), keep_default=False)

        # Deleting field 'RigaFattura.riga_fattura_consorzio'
        db.delete_column('fatturazione_rigafattura', 'riga_fattura_consorzio_id')
    ...
    models = {
        ...
        'fatturazione.rigafattura': {
            ...
            'conducente': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fatture'", 'null': 'True', 'to': "orm['tam.Conducente']"}),
            ...
            'riga_fattura_consorzio': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'fattura_conducente_collegata'", 'unique': 'True', 'null': 'True', 'to': "orm['fatturazione.RigaFattura']"}),
