...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fattura.cliente'
        db.add_column('fatturazione_fattura', 'cliente', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fatture', null=True, to=orm['tam.Cliente']), keep_default=False)

        # Adding field 'Fattura.passeggero'
        db.add_column('fatturazione_fattura', 'passeggero', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fatture', null=True, to=orm['tam.Passeggero']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Fattura.cliente'
        db.delete_column('fatturazione_fattura', 'cliente_id')

        # Deleting field 'Fattura.passeggero'
        db.delete_column('fatturazione_fattura', 'passeggero_id')
    ...
    models = {
        'fatturazione.fattura': {
            ...
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fatture'", 'null': 'True', 'to': "orm['tam.Cliente']"}),
            'data': ('django.db.models.fields.DateField', [], {}),
            'emessa_a': ('django.db.models.fields.TextField', [], {}),
            'emessa_da': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'passeggero': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fatture'", 'null': 'True', 'to': "orm['tam.Passeggero']"}),
