...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('fatturazione_rigafattura', 'conducente', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fatture', null=True, to=orm['tam.Conducente']), keep_default=False)
