...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Viaggio.data_padre'
        db.add_column('tam_viaggio', 'data_padre', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)

        # Adding field 'Viaggio.id_padre'
        db.add_column('tam_viaggio', 'id_padre', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Viaggio.data_padre'
        db.delete_column('tam_viaggio', 'data_padre')

        # Deleting field 'Viaggio.id_padre'
        db.delete_column('tam_viaggio', 'id_padre')
