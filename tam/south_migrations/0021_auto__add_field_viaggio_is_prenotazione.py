...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Viaggio.is_prenotazione'
        db.add_column('tam_viaggio', 'is_prenotazione',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Viaggio.is_prenotazione'
        db.delete_column('tam_viaggio', 'is_prenotazione')
