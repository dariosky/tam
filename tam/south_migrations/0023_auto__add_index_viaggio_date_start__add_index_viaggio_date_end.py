...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Viaggio', fields ['date_start']
        db.create_index(u'tam_viaggio', ['date_start'])

        # Adding index on 'Viaggio', fields ['date_end']
        db.create_index(u'tam_viaggio', ['date_end'])


    def backwards(self, orm):
        # Removing index on 'Viaggio', fields ['date_end']
        db.delete_index(u'tam_viaggio', ['date_end'])

        # Removing index on 'Viaggio', fields ['date_start']
        db.delete_index(u'tam_viaggio', ['date_start'])
    ...
    models = {
        ...
        u'tam.viaggio': {
            ...
            'date_end': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 1, 1, 0, 0)', 'db_index': 'True'}),
