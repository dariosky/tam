...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Conducente', fields ['attivo']
        db.create_index('tam_conducente', ['attivo'])

        # Adding field 'PrezzoListino.flag_fatturazione'
        db.add_column('tam_prezzolistino', 'flag_fatturazione', self.gf('django.db.models.fields.CharField')(default='-', max_length=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'ActionLog', fields ['data']
        db.delete_index('tam_actionlog', ['data'])

        # Deleting field 'PrezzoListino.flag_fatturazione'
        db.delete_column('tam_prezzolistino', 'flag_fatturazione')
