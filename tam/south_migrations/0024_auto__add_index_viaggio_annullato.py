...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Viaggio', fields ['annullato']
        db.create_index(u'tam_viaggio', ['annullato'])


    def backwards(self, orm):
        # Removing index on 'Viaggio', fields ['annullato']
        db.delete_index(u'tam_viaggio', ['annullato'])
