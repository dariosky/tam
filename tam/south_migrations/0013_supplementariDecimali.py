...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Viaggio.punti_notturni'
        db.alter_column('tam_viaggio', 'punti_notturni', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Viaggio.punti_diurni'
        db.alter_column('tam_viaggio', 'punti_diurni', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'Conducente.classifica_iniziale_notturni'
        db.alter_column('tam_conducente', 'classifica_iniziale_notturni', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Conducente.classifica_iniziale_diurni'
        db.alter_column('tam_conducente', 'classifica_iniziale_diurni', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Viaggio.punti_notturni'
        db.alter_column('tam_viaggio', 'punti_notturni', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Viaggio.punti_diurni'
        db.alter_column('tam_viaggio', 'punti_diurni', self.gf('django.db.models.fields.IntegerField')())
