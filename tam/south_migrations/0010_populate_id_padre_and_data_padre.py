...
class Migration(DataMigration):
    def forwards(self, orm):
        ...
        for viaggio in orm.Viaggio.objects.all():
            ...
            viaggio.id_padre = (
                viaggio.padre.id if viaggio.padre is not None else viaggio.id
            )
            viaggio.data_padre = (
                viaggio.padre.data if viaggio.padre is not None else viaggio.data
            )
            viaggio.save()

    #            print "a %s" % viaggio.data_padre
