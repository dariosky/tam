...
def changeLog(request, template_name="static/changelog.html"):
    ...
    known_changes = [
        ...
        (
            ...
            "29/10/2009",
            mark_safe(
                """	Gestione dettagliata dei permessi, ogni utente può avere accesso solo a determinate funzioni.
        ...
        (
            ...
            "23/11/2009",
            mark_safe(
                """<strong>Gestione utenti</strong>: gli utenti abilitati possono creare e cancellare gli utenti di TaM, modificarne le password (cancellando automaticamente tutte le sessioni aperte) e il gruppo di permessi.<br/>
        ...
        (
            ...
            "3/12/2009",
            mark_safe(
                """<strong>Log delle operazioni</strong>: pagina per la visione delle operazioni, log nella struttura dati, Signal per le operazioni sui modelli (Viaggi, Clienti, Conducenti, Tratte e prezzi listino).<br/>
        ...
        (
            ...
            "8/1/2010",
            mark_safe(
                """Visualizzazione classifiche: riordinati i doppi Venezia e compressi i supplementari.<br/>
        ...
        (
            ...
            "13/1/2010",
            mark_safe(
                """Aggiunto al Log delle operazioni la possibilità di filtrare in base all'utente che ha eseguito l'operazione<br/>
        ...
        (
            ...
            "13/2/2010",
            mark_safe(
                """Dietro le quinte: gestiti con Form.Media i Javascript e CSS; migrazioni gestite con South.<br/>
        ...
        (
            ...
            "18/2/2010",
            mark_safe(
                """I privati ora si possono creare al volo dalla prima pagina dell'inserimento corse.
        ...
        (
            ...
            "3/3/2010",
            mark_safe(
                """L'anagrafica dei clienti privati può ora essere cambiata direttamente dalle corse.<br/>
        ...
        (
            "1.17",
            "12/4/2010",
            mark_safe("Nel log delle modifiche evidenziate le corse inserite postume."),
        ),
        (
            "1.18",
            "14/4/2010",
        ...
        (
            ...
            "1/6/2010",
            mark_safe(
                """Aggiunta la data del doppio nella classifica Doppi.<br/>
        ...
        (
            ...
            "23/8/2010",
            mark_safe(
                """Corretto il conguaglio di corse con casette multiple in caso di conguagli parziali.<br/>
        ...
        (
            ...
            "24/10/2010",
            mark_safe(
                """Revisione della maschera strumenti.<br/>
        ...
        (
            ...
            "1/1/2011",
            mark_safe(
                """<strong>Archiviazione e appianamento su un altro DB.</strong><br/>
        ...
        (
            ...
            "3/8/2011",
            mark_safe(
                """Le esportazioni in Excel vengono loggate.<br>
        ...
        (
            ...
            "13/2/2012",
            mark_safe(
                """Quando parto da un aeroporto tengo conto di mezz'ora in più prima di ritornare.<br/>
        ...
        (
            ...
            "7/5/2012",
            mark_safe(
                """Aggiornamento a Django 1.4 e piccole migliorie varie.<br />
        ...
        (
            ...
            "17/5/2012",
            mark_safe(
                """Le ricevute si generano normalmente ma producono due documenti:<br/>
        ...
        (
            ...
            "4/6/2012",
            mark_safe(
                """Separata la gestione dei parametri per rendere le fatturazione e classifiche estraibili.<br/>
        ...
        (
            ...
            "1/7/2012",
            mark_safe(
                """Rivista la procedura di fatturazione per rendere tutto più dinamico e parametrizzabile.<br>
        ...
        (
            ...
            "24/9/2012",
            mark_safe(
                """Nell'elenco passeggeri privati, ora è possibile vedere
        ...
        (
            ...
            "1/10/2012",
            mark_safe(
                """Backup su PostgreSQL più veloce e senza problemi di lock in scrittura.<br/>
        ...
        (
            ...
            "22/10/2012",
            mark_safe(
                """Possibilità di generare un pdf di un blocco di fatture selezionate
        ...
        (
            ...
            "15/12/2012",
            mark_safe(
                """<b>Sistema di prenotazioni online</b> gestione clienti prenotazioni multiple,
        ...
        (
            "4.7",
            "19/2/2013",
            "Gli utenti delle prenotazioni vedono le corse inserite dal consorzio oltre alle prenotazioni.",
        )
        if prenotazioni
        else "",
        (
        ...
        (
            "5.1",
            "29/3/2013",
            "Memorizza quando nelle prenotazioni è stato inviato un allegato."
            if prenotazioni
            else "",
        ),
        (
        ...
        ("5.5", "1/4/2013", mark_safe("<b>Bacheca notizie in realtime.</b>"))
        if "board" in settings.PLUGGABLE_APPS
        else "",
        ("5.6", "18/6/2013", mark_safe("<b>Coda presenze.</b>"))
        if "codapresenze" in settings.PLUGGABLE_APPS
        else "",
        (
            "5.7",
            "24/6/2013",
            mark_safe("Gli utenti potenti ora possono gestire la coda di tutti."),
        )
        if "codapresenze" in settings.PLUGGABLE_APPS
        else "",
        (
        ...
        (
            ...
            "12/4/2014",
            mark_safe(
                "<b>Gestione presenze.</b> "
                + "Le classifiche viaggio tengono conto di ferie/permessi e viaggi contemporanei"
            ),
        )
        if "calendariopresenze" in settings.PLUGGABLE_APPS
        else "",
        ("6.0", "30/4/2014", "Schermata prenotazioni e login multilingua.")
        if "prenotazioni" in settings.PLUGGABLE_APPS
        else "",
        ("6.1", "11/7/2014", "Conservazione sicura degli allegati alle prenotazioni.")
        if "prenotazioni" in settings.PLUGGABLE_APPS
        else "",
        ("6.11", "22/7/2014", "Fix board per device touch.")
        if "board" in settings.PLUGGABLE_APPS
        else "",
        (
            "6.12",
        ...
        ("6.20", "28/2/2015", "Presenze resettabili custom.")
        if "calendariopresenze" in settings.PLUGGABLE_APPS
        else "",
        ("6.30", "10/4/2015", "Visualizzazione allegati prenotazioni.")
        if "prenotazioni" in settings.PLUGGABLE_APPS
        else "",
        ...
        ("6.7", "1/5/2016", "Controllo sessioni singole")
        if settings.FORCE_SINGLE_DEVICE_SESSION
        else "",
        (
            "6.72",
            "5/8/2016",
            "Webhooks per essere notificati degli errori di consegna delle email",
        ),
        (
            "6.72",
            "14/8/2016",
            "Preavviso per prenotazioni regolabile in base all'orario",
        ),
    ...
    for version in known_changes[::-1]:
        if not version:
            continue  # version può essere vuoto... salto la riga
