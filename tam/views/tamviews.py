...
def changeLog(request, template_name='static/changelog.html'):
	...
	known_changes = [
					...
					('1.17', '12/4/2010', mark_safe('Nel log delle modifiche evidenziate le corse inserite postume.')),
					('1.18', '14/4/2010', mark_safe('Il flag "conto fine mese" ora è disponibile ad ogni tipo di cliente.')),
					...
					('3.5', '28/5/2012', mark_safe('Log su DB separato per avere maggiore concorrenza in scrittura. Migliorata l\'occupazione su disco.')),
					...
					('3.7.4', '31/8/2012', mark_safe('Qualche ottimizzazione alla visualizzazione delle corse, campi data modificabili in testata fatture.')),
			
					('3.7.5', '7/9/2012', mark_safe('Evidenziati i prezzi a zero nella lista corse.')),
					('3.7.6', '21/9/2012', mark_safe('Le fatture conducente senza IVA, per i conducenti che non possono emettere senza IVA ora hanno l\'iva')),
					('3.7.7', '21/9/2012', mark_safe('Miglioramenti ai Task per i processi lunghi.')),
