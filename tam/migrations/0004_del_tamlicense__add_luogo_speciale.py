...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ActionLog.user'
        db.alter_column('tam_actionlog', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Deleting field 'Luogo.speciale'
        db.delete_column('tam_luogo', 'speciale')
