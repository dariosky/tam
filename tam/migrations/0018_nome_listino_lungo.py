...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tam_listino', 'nome', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30))

    def backwards(self, orm):

        # Changing field 'Listino.nome'
        db.alter_column('tam_listino', 'nome', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))
