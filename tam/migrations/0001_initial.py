...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('tam_tamlicense', (
        ...
        db.create_table('tam_passeggero', (
        ...
        db.create_table('tam_conducente', (
            ...
            ('classifica_iniziale_diurni', orm['tam.Conducente:classifica_iniziale_diurni']),
            ('classifica_iniziale_notturni', orm['tam.Conducente:classifica_iniziale_notturni']),
            ('classifica_iniziale_puntiDoppiVenezia', orm['tam.Conducente:classifica_iniziale_puntiDoppiVenezia']),
            ('classifica_iniziale_prezzoDoppiVenezia', orm['tam.Conducente:classifica_iniziale_prezzoDoppiVenezia']),
            ('classifica_iniziale_doppiPadova', orm['tam.Conducente:classifica_iniziale_doppiPadova']),
            ('classifica_iniziale_long', orm['tam.Conducente:classifica_iniziale_long']),
            ('classifica_iniziale_medium', orm['tam.Conducente:classifica_iniziale_medium']),
        ))
        db.send_create_signal('tam', ['Conducente'])
        
        # Adding model 'Listino'
        db.create_table('tam_listino', (
        ...
        db.create_table('tam_profiloutente', (
        ...
        db.create_table('tam_prezzolistino', (
        ...
        db.create_table('tam_conguaglio', (
        ...
        db.create_unique('tam_prezzolistino', ['listino_id', 'tratta_id', 'tipo_servizio', 'max_pax'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('tam_prezzolistino', ['listino_id', 'tratta_id', 'tipo_servizio', 'max_pax'])
    ...
    models = {
        ...
        'tam.cliente': {
            'attivo': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'commissione': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'dati': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'fatturazione': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'incassato_albergo': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            ...
            'pagamento_differito': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'tipo': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'tipo_commissione': ('django.db.models.fields.CharField', [], {'default': "'F'", 'max_length': '1'})
        },
        'tam.conducente': {
            'assente': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'attivo': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'classifica_iniziale_diurni': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'classifica_iniziale_doppiPadova': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'classifica_iniziale_long': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'classifica_iniziale_medium': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'classifica_iniziale_notturni': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'classifica_iniziale_prezzoDoppiVenezia': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
        ...
        'tam.conguaglio': {
            ...
            'dare': ('django.db.models.fields.DecimalField', [], {'default': '10', 'max_digits': '6', 'decimal_places': '2'}),
        ...
        'tam.prezzolistino': {
            'Meta': {'unique_together': "(('listino', 'tratta', 'tipo_servizio', 'max_pax'),)"},
            'commissione': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '6', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'prezzo_diurno': ('django.db.models.fields.DecimalField', [], {'default': '10', 'max_digits': '6', 'decimal_places': '2'}),
            'prezzo_notturno': ('django.db.models.fields.DecimalField', [], {'default': '10', 'max_digits': '6', 'decimal_places': '2'}),
            'tipo_commissione': ('django.db.models.fields.CharField', [], {'default': "'F'", 'max_length': '1'}),
        ...
        'tam.tratta': {
            ...
            'costo_autostrada': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
        ...
        'tam.viaggio': {
            ...
            'abbuono_fisso': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'abbuono_percentuale': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'arrivo': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            ...
            'conducente_confermato': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'conducente_richiesto': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'costo_autostrada': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'costo_sosta': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            ...
            'esclusivo': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'fatturazione': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            ...
            'is_valid': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'km': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'pagamento_differito': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'pagato': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'passeggero': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tam.Passeggero']", 'null': 'True', 'blank': 'True'}),
            'prezzo': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'prezzoDoppioPadova': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'prezzoPadova': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'prezzoPunti': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'prezzoVenezia': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'prezzo_finale': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
            'prezzo_sosta': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
