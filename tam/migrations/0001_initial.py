    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        editable=False, to=settings.AUTH_USER_MODEL, unique=True
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "conducente",
                    models.ForeignKey(blank=True, to="tam.Conducente", null=True),
                ),
                ("da", models.ForeignKey(related_name="da", to="tam.Luogo")),
                (
                    "luogoDiRiferimento",
                    models.ForeignKey(
                        related_name="riferimento", to="tam.Luogo", null=True
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                verbose_name=b"Listino cliente", blank=True, to="tam.Listino", null=True
            ),
            preserve_default=True,
        ),
    ]
