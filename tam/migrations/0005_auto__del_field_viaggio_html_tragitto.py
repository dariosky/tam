...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Viaggio.html_tragitto'
        db.delete_column('tam_viaggio', 'html_tragitto')


    def backwards(self, orm):
        
        # Adding field 'Viaggio.html_tragitto'
        db.add_column('tam_viaggio', 'html_tragitto', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
