...
def testing_annotations():
    ...
    Viaggio(
        data=date_enforce(datetime.date(2016, 1, 12)),
        da=lrif,
        a=lrif,
        luogoDiRiferimento=lrif,
        prezzo=10,
    ...
    Viaggio(
        data=date_enforce(datetime.date(2016, 2, 12)),
        da=lrif,
        a=lrif,
        luogoDiRiferimento=lrif,
        prezzo=10,
    ...
    anakin_runs = list(
        filter(lambda x: x["conducente__nome"] == "Anakin Skywalker", qs)
    )
