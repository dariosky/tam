...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'calendariopresenze_calendar', 'hours')

        # Adding field 'Calendar.minutes'
        db.add_column(u'calendariopresenze_calendar', 'minutes',
    ...
    def backwards(self, orm):
        ...
        raise RuntimeError("Cannot reverse this migration. 'Calendar.hours' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Calendar.hours'
        db.add_column(u'calendariopresenze_calendar', 'hours',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)

        # Deleting field 'Calendar.minutes'
        db.delete_column(u'calendariopresenze_calendar', 'minutes')
